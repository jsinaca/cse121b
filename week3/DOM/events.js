...
function newTask() {
  ...
  tasks.push({ detail: td, completed: false});
  // render out the list.
  renderTasks(tasks);
}
...
function manageTasks(event) {
  ...
  if (event.target.dataset.function === 'compleate') {
    completeTask(parent);
  }
}
